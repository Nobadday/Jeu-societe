...
void AnimatedObj::SetAnimation(int _animationIndex, bool _resetAnimation)
{
	if (_animationIndex <= -1)
	{
		this->m_animationSelected = -1;
...
void AnimatedObj::SetAnimation(const std::string& _animationName, bool _resetAnimation)
{
	if (this->m_texture != NULL)
	{
		int animIndex = this->m_texture->FindAnimationIndex(_animationName);
...
void AnimatedObj::AddAnimation(int _value, bool _wrap, bool _resetAnimation)
{
	if (this->m_texture != NULL)
	{
		int index = this->m_animationSelected + _value;
...
void AnimatedObj::SetTexture(TextureAnimated& _texture, bool _keepAnimation)
{
...
void AnimatedObj::AnimationChanged(void)
{
}
